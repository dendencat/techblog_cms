...
check "Base settings exist" "[ -f techblog_cms/settings.py ]"
check "Persistent DB connections configured" "grep -q \"DATABASES\['default'\]\['CONN_MAX_AGE'\]\" techblog_cms/settings.py"
check "HSTS configured" "grep -q 'SECURE_HSTS_SECONDS = 31536000' techblog_cms/settings.py"
